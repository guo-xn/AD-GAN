...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_gp', type=float, default=0.00001, help='gp loss')
    ...
    parser.add_argument('--image_dir', type=str, default='./celeba/celebatrain', help='image directory')
    parser.add_argument('--label_dir', type=str, default='./celeba/28000.txt', help='label directory')
    parser.add_argument('--masks_dir', type=str, default='./mask/trainmask', help='masks directory')
    
    parser.add_argument('--image_val_dir', type=str, default='./celeba/celebatrain', help='validation image directory')
